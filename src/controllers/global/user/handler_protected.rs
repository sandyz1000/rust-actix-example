...
use crate::utils::{
    error::ApiError,
    http_body::{get_data_from_middleware, Message, MessageWithData},
    validator::validate_input,
};

use super::data::{ChangePassword, GetProfile, UpdateProfile};
...
pub async fn get_profile(
    ...
    Ok(Json(MessageWithData { msg: "OK", data }))
}
